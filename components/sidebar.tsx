...
const routes = [
  { label: "Dashboard", icon: LayoutDashboard, color: "text-sky-500", href: "/dashboard" },
  ...
  { label: 'Video Generation', icon: VideoIcon, color: "text-orange-700", href: '/video' },
  { label: 'Music Generation', icon: Music, color: "text-emerald-500", href: '/music' },
  { label: 'Code Generation', icon: Code, color: "text-green-700", href: '/code' },
